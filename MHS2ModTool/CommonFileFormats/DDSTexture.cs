...
namespace MHS2ModTool.CommonFileFormats
{
    static class DDSTexture
    {
        ...
        private static DxgiFormat ConvertToDxgiFormat(ImageFormat format)
        {
            ...
            {
                ImageFormat.Bc1Srgb => DxgiFormat.FormatBC1UnormSrgb,
                ImageFormat.Bc1Unorm => DxgiFormat.FormatBC1Unorm,
        ...
        private static ImageFormat GetFormat(DdsPixelFormat pixelFormat)
        {
            if (pixelFormat.Flags.HasFlag(DdsPfFlags.FourCC))
            {
                ...
                {
                    Dxt1FourCC => ImageFormat.Bc1Unorm,
        ...
        private static ImageFormat ConvertToImageFormat(DxgiFormat format)
        {
            return format switch
            {
                DxgiFormat.FormatBC1UnormSrgb => ImageFormat.Bc1Srgb,
                DxgiFormat.FormatBC1Unorm => ImageFormat.Bc1Unorm,
